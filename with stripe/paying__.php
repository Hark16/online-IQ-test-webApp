...
$session = \Stripe\Checkout\Session::create([
    ...
    'line_items' => [[
        'price_data' => [
            'currency' => $row['cur'],
            'product_data' => [
                'name' => 'iQtesst Question Credits',
            ],
            'unit_amount' => $row['amt3'],
        ],
        'quantity' => 1,
    ]],
    'mode' => 'payment',
    'success_url' => 'https://iqtesst.com/success__.php?session_id={CHECKOUT_SESSION_ID}',
    'cancel_url' => 'https://iqtesst.com/cancel.php',
...
$username = $_SESSION['username'];
    $payment_status="you are going to add balance for Question credits";
