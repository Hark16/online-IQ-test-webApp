...
<p>for this service which is <br/>IQ tesst profile which include <br/>iq tesst report, <br/>advance eBook and <br/>many more thing <br/>you will be charge- <br/>$<?php echo $row['amt1']/100; ?> ...</p>
