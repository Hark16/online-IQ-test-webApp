...
$session = \Stripe\Checkout\Session::create([
    ...
    'line_items' => [[
        'price_data' => [
            'currency' => $row['cur'],
            'product_data' => [
                'name' => 'iQtesst Blog Credits',
            ],
            'unit_amount' => $row['amt2'],
        ],
        'quantity' => 1,
    ]],
    'mode' => 'payment',
    'success_url' => 'https://iqtesst.com/success_.php?session_id={CHECKOUT_SESSION_ID}',
...
$username = $_SESSION['username'];
    $payment_status="you are going to add balance for blog credits";
