	...
	<div class="container">
		...
		<div class="menu-menu-1-container">
			...
			<ul id="menu-menu-1" class="menu">
				...
				<li><a href="ask.php">Ask The Expert</a></li>

<?php

if(isset($_SESSION['username'])){
?>
				<li><a href="profile_main.php">Profile</a></li>
...
$sql = "SELECT COUNT(*) FROM $table WHERE live='yes' and $ftag = '$tag' ";
...
$sql = "SELECT * FROM $table WHERE live = 'yes' and $ftag = '$tag' LIMIT $offset, $rowsperpage ";
$result = mysqli_query($conn, $sql) or trigger_error("SQL", E_USER_ERROR);
...
?>
					...
					<div class="entry-summary">
						<p class="animate__animated animate__fadeIn animate__slow">
							<?php echo $row['description']; ?><a class="more-link" href="article.php?slag=<?php echo $row['slag']; ?>">Read more</a>
						</p>
					</div>
