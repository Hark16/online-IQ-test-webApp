...
<form method='POST'>
<input type='text' name='permalink' placeholder='enter permalink here' />
<br/>
...
$permalink1 = mysqli_real_escape_string($conn, $_POST['permalink']);
...
header("Location: all-posts-slag-insert.php");

}else{
echo 'already taken, try another one';
}
}
