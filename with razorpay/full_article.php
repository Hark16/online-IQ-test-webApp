...
<p class="animate__animated animate__fadeIn animate__slow"><?php echo $row['introduction']; ?></p>
...
<p class=" animate__animated animate__fadeIn animate__slow"><?php echo $row['conclusion']; ?></p>
