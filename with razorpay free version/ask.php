...
<pre class=" animate__animated animate__fadeIn animate__slow" style="white-space:pre-wrap;">
...
echo '<h3 style="background-color:blue; color:white;"><a href="ask1.php"> Ask The Expert </a></h3>';

}

else{
echo '<h4 style="background-color:red ; color:white;">Sorry but you do not have Credits for Asking Questions.</h4>';
echo '<h3 style="background-color:green;color:white;">Please go to your profile and buy some credits for asking.</h3>';
...
<h3 style="background-color:blue; color:white;">Please <a href='login.php'>Login</a> to use this service</h3>
<h4 style="background-color:orange ; color:white;">If you do not have account? Please take our <a href='test.php'>iQ test</a></h4>
