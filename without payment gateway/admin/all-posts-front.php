...
<input type='text' name='writer' placeholder= 'writer name' value='<?php echo $row['writer']; ?>'/>
<br/>
<input type='text' name= 'author_code' placeholder= 'author code' value='<?php echo $row['author_code']; ?>' hidden/>
<br/>
...
$writer1 = mysqli_real_escape_string($conn, $_POST['writer']);
$writer = filter_var($writer1, FILTER_SANITIZE_STRING);
$author_code1 = mysqli_real_escape_string($conn, $_POST['author_code']);
$author_code = filter_var($author_code1, FILTER_SANITIZE_STRING);
