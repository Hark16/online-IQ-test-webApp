...
$author_code = $_SESSION['author_code'] ;
...
mysqli_query($conn, "UPDATE $table SET writer = '$writer' WHERE permalink = '$permalink'");
mysqli_query($conn, "UPDATE $table SET author_code = '$author_code' WHERE permalink = '$permalink'");
