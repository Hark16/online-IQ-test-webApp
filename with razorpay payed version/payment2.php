...
$username= filter_var($username1, FILTER_SANITIZE_STRING);
    ...
    $payment_status="you did not add balance for blog credits";
...
$payment_id= filter_var($payment_id1, FILTER_SANITIZE_STRING);
    ...
    mysqli_query($conn, "update payment set payment_status='your payment is done for 20 blog credits',payment_id='$payment_id' where id='".$_SESSION['OID']."'");
...
$old_credits = $row2['blog_credits'];
$new_credits = $old_credits + 20;
$_SESSION['username'] = $username;

$msg= "Congratulation your 20 Blog credits added on your account";
$date=date("d/m/Y");
...
$update2 = "UPDATE vidyarthi SET blog_credits = '$new_credits' WHERE username = '$username' ";
